...
$_MT['crisp_id']                    = '20c98db7-5ab2-46a3-9127-bde49f0dcda8';  // Crisp 的网站ID，格式类似 '18b46e92-eb21-76d3-bfb7-8f2ae9adba64'
...
$_MT['shop_plan'] = array(
    ...
    '黄金套餐' => array(            // 需要多个套餐可以自己复制array增加到下面
        '描述' => array(
            '月付' => 4,
            '半年' => 5,
            '年付' => 6,
...
$_MT['ios_password'] = 'Bh324567';    //ios密码
